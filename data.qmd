...
Themes for indicators seeking relevance to:
- Land & Sea
- People & Ecosystems

Icons
- Bootstrap
  - [water](https://icons.getbootstrap.com/icons/water/)
  - [thermometer](https://icons.getbootstrap.com/icons/thermometer/)
    - [moisture](https://icons.getbootstrap.com/icons/moisture/)
    - [thermometer-sun](https://icons.getbootstrap.com/icons/thermometer-sun/)
  - [cloud-rain-heavy-fill](https://icons.getbootstrap.com/icons/cloud-rain-heavy-fill/)
  - [tornado](https://icons.getbootstrap.com/icons/tornado/)
- Fontawesome
  - [water-rise](https://fontawesome.com/v5/icons/water-rise?f=classic&s=solid) PRO
...
- [FAQ for Sea Level Trends | NOAA Tides & Currents](https://tidesandcurrents.noaa.gov/sltrends/faq.html#:~:text=Relative%20Sea%20Level%20Trends%20reflect%20changes,stations%2C%20called%20monthly%20mean%20sea%20level.)
...
- [Tidal Datums | NOAA Tides & Currents](https://tidesandcurrents.noaa.gov/datum_options.html)
-  Water Level Monthly Mean Data
...
station_id
slr_csv <- "https://tidesandcurrents.noaa.gov/sltrends/data/{station_id}_meantrend.csv"
slr_csv <- "https://tidesandcurrents.noaa.gov/sltrends/data/8726724_meantrend.csv"

rm(d)
d <- suppressWarnings(
  request("https://tidesandcurrents.noaa.gov") |> 
    req_url_path_append(
      "sltrends", "data", 
      glue("{station_id}_meantrend.csv")) |> 
    req_perform() |> 
    resp_body_string() |> 
    read_csv(
      skip           = 5, 
...
https://api.tidesandcurrents.noaa.gov/mdapi/prod/webapi/stations/9414290.json https://api.tidesandcurrents.noaa.gov/mdapi/prod/webapi/stations/id/resource.extension https://api.tidesandcurrents.noaa.gov/mdapi/prod/webapi/stations/8726724/datums.json "units": "feet", "datums": "name": "MSL", "description": "Mean Sea Level", "value": 3.2 "min": -0.84, "mindate": "19770119", "mintime": "08:06", "max": 8.491, "maxdate": "19930313", "maxtime": "04:48",

https://api.tidesandcurrents.noaa.gov/mdapi/prod/webapi/ports.extension https://api.tidesandcurrents.noaa.gov/mdapi/prod/webapi/ports.json

```{r}
librarian::shelf(
  dplyr, httr2, purrr, readr, tibble)
# # register with renv
# library(dplyr)
# library(httr2)
# library(readr)
...
d_csv <- here::here("data/slr/monthly_sea_levels.csv")
...
get_station_data <- function(station_id){
  httr2::request("https://api.tidesandcurrents.noaa.gov/api/prod/datagetter") |> 
    httr2::req_url_query(
      station     = station_id,
      begin_date  = 19010101,
      end_date    = lubridate::today()  |> format("%Y%m%d") |> as.integer(), 
      product     = "monthly_mean", # maxdur = 3653 days (10 yrs)
      datum       = "stnd",
...
# d
# # A tibble: 1,868 × 20
#    station_id station_name      Year Month Highest  MHHW   MHW   MSL   MTL   MLW
#         <dbl> <chr>            <dbl> <dbl>   <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>
#  1    8726724 Clearwater Beach  1973     5    1.55  1.38  1.26 0.96  0.96  0.658
#  2    8726724 Clearwater Beach  1973     6    1.61  1.38  1.25 0.951 0.954 0.655
#  3    8726724 Clearwater Beach  1973     7    1.58  1.38  1.25 0.951 0.942 0.631
#  4    8726724 Clearwater Beach  1973     8    1.57  1.40  1.28 0.981 0.972 0.668
#  5    8726724 Clearwater Beach  1973     9    1.54  1.43  1.33 1.04  1.03  0.732
#  6    8726724 Clearwater Beach  1973    10    1.66  1.38  1.29 1.02  1.02  0.747
#  7    8726724 Clearwater Beach  1973    11    1.64  1.40  1.29 1.01  1.02  0.753
#  8    8726724 Clearwater Beach  1973    12    1.53  1.28  1.16 0.896 0.893 0.622
#  9    8726724 Clearwater Beach  1974     1    1.53  1.30  1.16 0.872 0.866 0.573
# 10    8726724 Clearwater Beach  1974     2    1.61  1.27  1.15 0.869 0.863 0.579
# # ℹ 1,858 more rows
# # ℹ 10 more variables: MLLW <dbl>, DTL <dbl>, GT <dbl>, MN <dbl>, DHQ <dbl>,
# #   DLQ <dbl>, HWI <dbl>, LWI <dbl>, Lowest <dbl>, Inferred <dbl>
# # ℹ Use `print(n = ...)` to see more rows
# names(d) |> paste(collapse=", ")
# station_id, station_name, Year, Month, Highest, MHHW, MHW, MSL, MTL, MLW, MLLW, DTL, GT, MN, DHQ, DLQ, HWI, LWI, Lowest, Inferred
# 
# https://tidesandcurrents.noaa.gov/axis/webservices/waterlevelverifiedmonthly/response.jsp?stationId=8726724&beginDate=20220201&endDate=20240514&datum=MSL&unit=0&timeZone=0&format=html&Submit=Submit
...
mapView(tbshed, col.regions="gray") + 
  mapView(tbshed_buf)
